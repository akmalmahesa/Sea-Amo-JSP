...
<head>
    <meta charset="UTF-8">
    <title>Tambah Produk - SeaAmo</title>
    <style>
        ...
        <div class="form-card">
            ...
            <form action="<%= request.getContextPath() %>/product" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="productName" class="form-input" placeholder="Contoh: Ikan Kakap Merah Segar" required>
                </div>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input type="number" name="price" class="form-input" placeholder="0" min="1000" step="500" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-textarea" rows="4" placeholder="Jelaskan kondisi ikan, waktu tangkap, dll..." required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="fileInputSection">
                        ...
                        <p style="font-size: 12px; color: #999; margin-top: 5px;">Maksimal 5MB. Format: JPG, PNG.</p>
                    </div>

                    <div id="urlInputSection" style="display: none;">
                        <input type="url" name="imageUrlInput" class="form-input" placeholder="https://example.com/gambar-ikan.jpg" oninput="previewUrl(this.value)">
                        <p style="font-size: 12px; color: #999; margin-top: 5px;">Masukkan link gambar langsung (harus berakhiran .jpg, .png, dll)</p>
                    </div>

                    <img id="imagePreview" class="img-preview" alt="Preview Gambar">
                </div>
        ...
        function previewUrl(url) {
            ...
            if (url) {
                ...
                preview.onerror = function() {
                    this.style.display = 'none'; // Sembunyikan jika URL rusak
                }
            } else {
                preview.style.display = 'none';
            }
